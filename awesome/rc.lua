...
tyrannical.tags = {
  ...
  },
  {
    ...
    ncol        = 1,
    layout      = layouts[3],
    class       = {"jetbrains-pycharm-ce", "jetbrains-pycharm","Google-chrome-beta", "jetbrains-webstorm", "MonoDevelop", "Code::Blocks", "Scala IDE", "Codelite", "Atom", "Java", "jetbrains-idea-ce", "LocalTestRunner", "jetbrains-idea-c", "jetbrains-idea", "Code", "jetbrains-rider"}
  },
  {
    name        = "img",
    init        = false,
  ...
  tyrannical.properties.intrusive = {
    "termite", "Gpick",    "ksnapshot"     , "pinentry"       , "gtksu"     , "kcalc"        , "xcalc"           ,
  ...
  tyrannical.properties.floating = {
    "Gpick", "MPlayer"      , "pinentry"        , "ksnapshot"  , "pinentry"     , "gtksu"          , "Go-for-it",
  ...
  tyrannical.properties.size_hints_honor = { termite = false, xterm = false, URxvt = false, aterm = false, sauer_client = false, mythfrontend  = false}
...
awful.key({ modkey }, "b", function ()
    ...
    awful.key({ modkey, "Shift"   }, "h",      function () awful.tag.incmwfact(-2.05)     end),
  ...
  awful.key({ modkey,           }, "z",
   ...
   awful.key({ }, "XF86AudioMute",         APW.ToggleMute),
    ...
    awful.key({ modkey }, "i", function () awful.spawn(browser2) end),
